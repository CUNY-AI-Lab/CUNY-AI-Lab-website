...
Introduce the CAIL Sandbox by explaining what it does, its limitations, and how students are expected to use it in your course. Adapt the first-week plan below to your discipline and assignments.

---

## Arrange Course Access<span id="instructor-checkpoint-complete-course-access-first" aria-hidden="true"></span>

**Get course approval before setting up the class or inviting students.** An individual account does not enroll your course.

1. Submit a [course access request](https://ailab.gc.cuny.edu/request-access/?kind=class). Select **A class I'm teaching or organizing**, sign in with CUNY Login, and provide the requested course details. One application covers your class. **Students do not submit individual access requests; they join through the course invitation link.**
2. After approval, open your course in [My classes](https://tools.ailab.gc.cuny.edu/my-classes), review its enrollment dates, and create or copy its reusable invitation link.
3. Open the [Sandbox](https://chat.ailab.gc.cuny.edu/) with CUNY Login. Confirm access to your course’s automatically created **private group and text channel**, and use the group to share models and knowledge bases.
4. Share the invitation and follow the first-login steps below with students. Enrollment and Sandbox sign-in add them to the course group and text channel automatically.

Before the first Sandbox activity, check the roster in **My classes** and resolve enrollment or login problems. For help, contact [ailab@gc.cuny.edu](mailto:ailab@gc.cuny.edu).
...
Students arrive with different experiences and assumptions about AI. Some may regard any use as cheating; others may expect it to write their papers. State what the course permits so students can judge their use against the assignment’s requirements.
...
Adapt the template to the uses you permit in each assignment.
...
1. Open the **course invitation link provided by your instructor**. Going directly to the Sandbox does not enroll you in the course.
2. Sign in with **CUNY Login** and complete the confirmation prompts to join the course.
3. Navigate to [chat.ailab.gc.cuny.edu](https://chat.ailab.gc.cuny.edu/).
4. Select **Continue with CUNY Login** and authenticate again if prompted.
5. Confirm that the course's private text channel is available, then locate the course model in the selector on the right inside the message box. Course group and channel membership are added automatically through this onboarding process.
...
Circulate and answer questions while students explore the interface at their own pace.
...
<div class="callout">
  <strong>For TAs and teaching staff.</strong> Spend 30 minutes exploring the course model before the semester starts so you can answer students’ questions from experience.
</div>
