...
An undergraduate composition course (ENG 110) focuses on developing academic writing skills. Students write four essays across the semester, covering narrative, analysis, argument, and research-based writing. Many students are multilingual or returning to college after years away. The instructor uses iterative feedback but cannot provide extensive comments on every draft.
...
- The model asks, "What is the central moment in your story? How does each paragraph lead to or away from that moment?"
...
- The model asks, "What textual evidence supports your interpretation? What alternative interpretations might a reader consider?"
...
- The model challenges weak reasoning with "You claim X. What would someone who disagrees say? How do you respond to that objection?"
...
- The model asks, "How does this source support your argument? What does it add that your other sources do not?"
...
- The model prompts students with "What patterns do you see? What surprises you? What alternative explanations might account for these findings?"
...
An advanced academic writing course serves multilingual graduate students who are developing their academic English. Students work on disciplinary conventions, sentence-level clarity, and source integration through writing in their fields, including STEM, social sciences, and the humanities.
...
A senior capstone seminar requires a major independent project involving original research, a creative work with critical reflection, or a community-based project. Students work across the semester with milestones and checkpoints. The instructor provides guidance but cannot meet with every student weekly.
...
- The model asks, "What makes this project significant? How does it build on prior work in your field?"
...
- The model provides weekly check-in questions such as "What progress have you made this week? What obstacles have you encountered?"
...
- Clarify that major project decisions require instructor feedback and approval, even when students discuss them with the model.
