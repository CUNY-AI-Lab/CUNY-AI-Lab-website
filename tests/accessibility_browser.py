...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        try:
            ...
            for width, paths in ((1440, routes), (390, ["/", "/tools/", "/models/", "/models/guide/", "/request-access/?kind=class", "/docs/api-keys/", "/sandbox-docs/", "/sandbox-docs/system-prompts/"])):
            ...
            for width in (1440, 390):
                ...
                page.get_by_role("searchbox", name="Search models", exact=True).fill("no-such-model")
                check_accessibility(page, f"{width}px no matching models")
            ...
            print("PASS axe WCAG A/AA: loaded/filtered models and tool categories")
